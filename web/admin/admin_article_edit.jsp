...
<form action="" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        <tr>
            ...
            <td width="40%">
                <input type="text" id="title" name="title" value="娃哈哈"/>
            </td>
            <td width="10%" class="tableleft">交流区</td>
            <td width="40%">
                <select name="zoneId">
                    <option value="" selected>综合交流区</option>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="content" id="content" rows="15" style="width:100%;">娃哈哈123</textarea>
            </td>
        </tr>
        <tr>
